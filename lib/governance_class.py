...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to monoecid "gobject list" output
    ...
    def monoecid_serialise(self):
        import monoecilib
        return monoecilib.SHIM_serialise_for_monoecid(self.serialise())
